...
!$OMP& xib,yib,zib,xic,yic,zic,xab,yab,zab,xcb,ycb,zcb,rab2,rcb2,xp,
!$OMP& yp,zp,rp,dot, cosine, angle,dt,dt2,dt3,dt4,e,deddt,factor,
!$OMP& sine, fold,terma, termc, dedxia, dedyia, dedzia, dedxic,dedzic,
!$OMP& dedxib,dedyib,dedzib,dedyic,vxx,vzx,vyy,vzy,vzz,xid,yid, vyx,
