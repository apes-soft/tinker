...
!$OMP& zcb,rab2,rcb2,rab,rcb,xp,yp,zp,rp,dot,cosine,angle,
!$OMP& dt,term1,term2,ddtdxia,ddtdyia,ddtdxic,ddtdyic,ddtdzic,
...
!$OMP& reduction(+:eba,deba,vir) schedule(guided)
c
