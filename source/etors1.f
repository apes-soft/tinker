...
!$OMP DO private(ia,ib,ic,id,proceed,fgrp,xia,yia,zia,xib,yib,zib,
!$OMP& xic,yic,zic,xid,yid,zid,xba,yba,zba,xcb,ycb,zcb,xdc,ydc,
!$OMP& zdc,xt,yt,zt,xu,yu,zu,xtu,ytu,ztu,rt2,ru2,rtru,rcb,cosine,
!$OMP& sine,v1,c1,s1,v2,c2,s2,v3,c3,s3,v4,c4,s4,v5,c5,s5,v6,c6,
!$OMP& s6,cosine2,sine2,cosine3,sine3,cosine4,sine4,cosine5,sine5,
!$OMP& cosine6,sine6,phi1,phi2,phi3,phi4,phi5,phi6,dphi1,dphi2,
