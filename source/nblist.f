...
c
      ...
      call splitloop(lstart, lend, nvdw)
...
!$OMP END PARALLEL
      ...
      allocate (temp(n))
      allocate (temp_list(maxvlst, n))
      temp = 0
      
      call MPI_ALLreduce(nvlst,temp, n, MPI_integer, MPI_SUM, 
     &     MPI_COMM_WORLD, ierror)
      
      nvlst = temp
      temp_list = 0 

      call MPI_Allreduce(vlst,temp_list,maxvlst*n, MPI_integer, 
