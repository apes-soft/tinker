...
c
               ...
               if (kax .eq. 0)  kax = kk
               if (kay .eq. 0)  kay = kk
               xiz = pos(1,iaz) - pos(1,ii)
               yiz = pos(2,iaz) - pos(2,ii)
               ziz = pos(3,iaz) - pos(3,ii)
               xix = pos(1,iax) - pos(1,ii)
               yix = pos(2,iax) - pos(2,ii)
               zix = pos(3,iax) - pos(3,ii)
               xiy = pos(1,iay) - pos(1,ii)
               yiy = pos(2,iay) - pos(2,ii)
               ziy = pos(3,iay) - pos(3,ii)
               xkz = pos(1,kaz) - pos(1,kk)
               ykz = pos(2,kaz) - pos(2,kk)
               zkz = pos(3,kaz) - pos(3,kk)
               xkx = pos(1,kax) - pos(1,kk)
               ykx = pos(2,kax) - pos(2,kk)
               zkx = pos(3,kax) - pos(3,kk)
               xky = pos(1,kay) - pos(1,kk)
               yky = pos(2,kay) - pos(2,kk)
               zky = pos(3,kay) - pos(3,kk)
