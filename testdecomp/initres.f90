...
subroutine initres
  ...
  integer, dimension(maxamino):: nt,cat
  integer, dimension(maxamino):: ct,hnt
  integer, dimension(maxamino):: ot,hat
  integer, dimension(maxamino):: cbt
  integer, dimension(maxamino):: nn,can
  integer, dimension(maxamino):: cn,hnn
  integer, dimension(maxamino):: on,han
  integer, dimension(maxamino):: nc,cac
  integer, dimension(maxamino):: cc,hnc
  integer, dimension(maxamino):: oc,hac
  integer, dimension(maxnuc):: o5t,c5t
  integer, dimension(maxnuc):: h51t,h52t
  integer, dimension(maxnuc):: c4t,h4t
  integer, dimension(maxnuc):: o4t,c1t
  integer, dimension(maxnuc):: h1t,c3t
  integer, dimension(maxnuc):: h3t,c2t
  integer, dimension(maxnuc):: h21t,o2t
  integer, dimension(maxnuc):: h22t,o3t
  integer, dimension(maxnuc):: pt,opt
  integer, dimension(maxnuc):: h5tt,h3tt
  character (len=1), dimension(maxamino):: acid1
  character (len=1), dimension(maxnuc):: base1
  character (len=3), dimension(maxamino):: acid3
  character (len=3), dimension(maxnuc):: base3
